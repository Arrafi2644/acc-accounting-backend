...
router.get('/', seo_controller_1.SEOControllers.getAllSeo);
router.get('/:pagePath', seo_controller_1.SEOControllers.getSinglePageSEO);
...
router.patch('/:id', (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), (0, validateRequest_1.validateRequest)(seo_validation_1.updateSEOZodSchema), seo_controller_1.SEOControllers.updateSEO);
